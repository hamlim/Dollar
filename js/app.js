            ...
            $('.expense-info').on('click', '', function() {
                ...
                for(var j=0; j<userExpenses.length; j++){
                    if(userExpenses[j].id === uniqueRowID){
                        ...
                        vex.dialog.alert({
                            message: '<ul><li>Amount: </li><ul><li class=\'currency\'>$'+userExpenses[j].fields.d_amount+'</li></ul><li>Location: </li><ul><li>'+userExpenses[j].fields.d_location+'</li></ul><li>Time: </li><ul><li>'+readable+'</li></ul><li>Notes: </li><ul><li>'+marked(userExpenses[j].fields.d_notes)+'</li></ul></ul>'
                        });
                    }
                }
            });
                    ...
                    $('.expense-info').on('click', '', function() {
                        ...
                        for(var k=0; k<userExpenses.length; k++){
                            if(userExpenses[k].id === uniqueRowID){
                                ...
                                var readable = converted._d;
                                vex.dialog.alert({
                                    message: '<ul><li>Amount: </li><ul><li class=\'currency\'>$'+userExpenses[k].fields.d_amount+'</li></ul><li>Location: </li><ul><li>'+userExpenses[k].fields.d_location+'</li></ul><li>Time: </li><ul><li>'+readable+'</li></ul><li>Notes: </li><ul><li>'+marked(userExpenses[k].fields.d_notes)+'</li></ul></ul>'
                                });
                            }
                        }
                    });
