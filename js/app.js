function safeLocalStorageAccess() {
            ...
            if (userExpenses[j].id === uniqueRowID) {
              ...
              vex.dialog.alert({
                message:
                  ...
                  userExpenses[j].fields.d_amount +
                  '</li></ul><li>Tag: </li><ul><li>' +
                  userExpenses[j].fields.d_tag +
                  '</ul><li>Location: </li><ul><li>' +
                  userExpenses[j].fields.d_location +
                  '</li></ul><li>Time: </li><ul><li>' +
                  readable +
                  '</li></ul><li>Notes: </li><!--<ul><li>--><div class="code">' +
                  marked(userExpenses[j].fields.d_notes) +
                  '</div><!--</li></ul>--></ul>',
              })
            }
          }
