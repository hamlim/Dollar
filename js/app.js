            ...
            $('.expense-info').on('click', '', function() {
                ...
                for(var j=0; j<userExpenses.length; j++){
                    if(userExpenses[j].id === uniqueRowID){
                        ...
                        vex.dialog.alert({
                            message: '<ul><li>Amount: </li><ul><li class=\'currency\'>$'+userExpenses[j].fields.d_amount+'</li></ul><li>Location: </li><ul><li>'+userExpenses[j].fields.d_location+'</li></ul><li>Time: </li><ul><li>'+readable+'</li></ul><li>Notes: </li><ul><li class="code">'+marked(userExpenses[j].fields.d_notes)+'</li></ul></ul>'
                        });
                    }
                }
            });
