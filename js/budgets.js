        ...
        $.ajax(settings).done(function(response) {
          ...
          for (var i = 0; i < response.records.length; i++) {
            if (response.records[i].fields.mb_userIDFK === userid) {
              ...
              currentState.personal.percentage =
                currentState.personal.spent.toFixed(2) / currentState.personal.budget.toFixed(2)
              currentState.home.percentage =
                currentState.home.spent.toFixed(2) / currentState.home.budget.toFixed(2)
              currentState.health.percentage =
                currentState.health.spent.toFixed(2) / currentState.health.budget.toFixed(2)
              currentState.travel.percentage =
                currentState.travel.spent.toFixed(2) / currentState.travel.budget.toFixed(2)
              currentState.transportation.percentage =
                currentState.transportation.spent.toFixed(2) /
                currentState.transportation.budget.toFixed(2)
              currentState.food.percentage =
                currentState.food.spent.toFixed(2) / currentState.food.budget.toFixed(2)
              currentState.other.percentage =
                currentState.other.spent.toFixed(2) / currentState.other.budget.toFixed(2)
              currentState.utilities.percentage =
                currentState.utilities.spent.toFixed(2) / currentState.utilities.budget.toFixed(2)
              currentState.gifts.percentage =
                currentState.gifts.spent.toFixed(2) / currentState.gifts.budget.toFixed(2)

              //set progress bars to the right percentage
              document
                .getElementById('food-progress')
                .setAttribute(
                  'data-progress-percent',
                  (currentState.food.percentage * 100).toFixed(0),
                )
              moveProgressBar()
              document
                .getElementById('other-progress')
                .setAttribute(
                  'data-progress-percent',
                  (currentState.other.percentage * 100).toFixed(0),
                )
              moveProgressBar()
              document
                .getElementById('home-progress')
                .setAttribute(
                  'data-progress-percent',
                  (currentState.home.percentage * 100).toFixed(0),
                )
              moveProgressBar()
              document
                ...
                .setAttribute(
                  'data-progress-percent',
                  (currentState.health.percentage * 100).toFixed(0),
                )
              moveProgressBar()
              document
                .getElementById('travel-progress')
                .setAttribute(
                  'data-progress-percent',
                  (currentState.travel.percentage * 100).toFixed(0),
                )
              moveProgressBar()
              document
                .getElementById('transportation-progress')
                .setAttribute(
                  'data-progress-percent',
                  (currentState.transportation.percentage * 100).toFixed(0),
                )
              moveProgressBar()
              document
                .getElementById('personal-progress')
                .setAttribute(
                  'data-progress-percent',
                  (currentState.personal.percentage * 100).toFixed(0),
                )
              moveProgressBar()
              document
                .getElementById('utilities-progress')
                .setAttribute(
                  'data-progress-percent',
                  (currentState.utilities.percentage * 100).toFixed(0),
                )
              moveProgressBar()
              document
                .getElementById('gifts-progress')
                .setAttribute(
                  'data-progress-percent',
                  (currentState.gifts.percentage * 100).toFixed(0),
                )
              moveProgressBar()
              ...
              personal_PV.innerHTML =
                (currentState.personal.percentage.toFixed(2) * 100).toString() + '%'
              travel_BV.innerHTML = '$' + currentState.travel.budget.toString()
              travel_SV.innerHTML = '$' + currentState.travel.spent.toString()
              travel_PV.innerHTML =
                (currentState.travel.percentage.toFixed(2) * 100).toString() + '%'
              ...
              health_PV.innerHTML =
                (currentState.health.percentage.toFixed(2) * 100).toString() + '%'
              ...
              transportation_PV.innerHTML =
                (currentState.transportation.percentage.toFixed(2) * 100).toString() + '%'
              ...
              utilities_PV.innerHTML =
                (currentState.utilities.percentage.toFixed(2) * 100).toString() + '%'
              ...
              if (currentState.personal.percentage.toFixed(2) * 100 <= 30) {
                ...
                currentState.personal.percentage.toFixed(2) * 100 <= 70 &&
                currentState.personal.percentage.toFixed(2) * 100 >= 30
              ) {
              ...
              if (currentState.other.percentage.toFixed(2) * 100 <= 30) {
                ...
                currentState.other.percentage.toFixed(2) * 100 <= 70 &&
                currentState.other.percentage.toFixed(2) * 100 >= 30
              ) {
              ...
              if (currentState.travel.percentage.toFixed(2) * 100 <= 30) {
                ...
                currentState.travel.percentage.toFixed(2) * 100 <= 70 &&
                currentState.travel.percentage.toFixed(2) * 100 >= 30
              ) {
              ...
              if (currentState.home.percentage.toFixed(2) * 100 <= 30) {
                ...
                currentState.home.percentage.toFixed(2) * 100 <= 70 &&
                currentState.home.percentage.toFixed(2) * 100 >= 30
              ) {
              ...
              if (currentState.health.percentage.toFixed(2) * 100 <= 30) {
                ...
                currentState.health.percentage.toFixed(2) * 100 <= 70 &&
                currentState.health.percentage.toFixed(2) * 100 >= 30
              ) {
              ...
              if (currentState.transportation.percentage.toFixed(2) * 100 <= 30) {
                ...
                currentState.transportation.percentage.toFixed(2) * 100 <= 70 &&
                currentState.transportation.percentage.toFixed(2) * 100 >= 30
              ) {
              ...
              if (currentState.gifts.percentage.toFixed(2) * 100 <= 30) {
                ...
                currentState.gifts.percentage.toFixed(2) * 100 <= 70 &&
                currentState.gifts.percentage.toFixed(2) * 100 >= 30
              ) {
              ...
              if (currentState.utilities.percentage.toFixed(2) * 100 <= 30) {
                ...
                currentState.utilities.percentage.toFixed(2) * 100 <= 70 &&
                currentState.utilities.percentage.toFixed(2) * 100 >= 30
              ) {
              ...
              if (currentState.food.percentage.toFixed(2) * 100 <= 30) {
                ...
                currentState.food.percentage.toFixed(2) * 100 <= 70 &&
                currentState.food.percentage.toFixed(2) * 100 >= 30
              ) {
