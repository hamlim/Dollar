...
export function BallotBox(props) {
  return React.createElement("svg", _extends({}, props, {
    ...
    d: "m72.41 53.6-23.13-23.14c-1.74-1.74-1.74-4.57 0-6.31s4.57-1.74 6.31 0l23.13 23.13c1.74 1.74 1.74 4.57 0 6.31-1.74 1.75-4.57 1.75-6.31 0.01z"
  }), React.createElement("path", {
    d: "m49.28 47.29 23.13-23.13c1.74-1.74 4.57-1.74 6.31 0s1.74 4.57 0 6.31l-23.13 23.13c-1.74 1.74-4.57 1.74-6.31 0-1.74-1.75-1.74-4.57 0-6.31z"
  })), React.createElement("linearGradient", {
    id: "BallotBox-b",
    x1: 63.999,
    x2: 63.999,
