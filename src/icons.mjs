  ...
  return (
    ...
    >
      ...
      >
        ...
        <stop stopColor="#66BB6A" offset=".9992" />
      </linearGradient>
      <path
      ...
      <circle cx="84.65" cy="63.88" r="18.5" fill="#2E7D32" opacity=".5" />
      <path
...
export function FlyingMoney(props) {
  return (
    <svg
      {...props}
      enableBackground="new 0 0 128 128"
    ...
    >
      ...
      <line x1="57.68" x2="57.75" y1="15.11" y2="15.14" fill="url(#flying-money-b)" />
      <linearGradient
        id="flying-money-icon-a"
        x1="56.665"
        x2="56.665"
        y1="125.3"
        y2="37.567"
      ...
      <circle cx="61.79" cy="48.55" r="13.59" fill="#2E7D32" opacity=".5" />
      <path
        d="m35.54 46.86c4.28-5.38 8.29-10.95 10.99-17.07-2.7 6.11-6.7 11.66-10.97 17.04-6.68 8.4-14.07 16.46-18.4 25.93 4.32-9.47 11.71-17.51 18.38-25.9z"
        fill="#2E7D32"
      />
      <polygon points="92.76 31.02 56.21 14.44 92.67 30.98" fill="#2E7D32" />
      <path
        d="m77.28 78.63c10.44-13.13 22.62-25.21 22.11-43.39 0.04-0.71-0.35-1.41-1.04-1.72-0.01 0-0.02 0-0.02-0.01l-5.42-2.46c1.13 18.88-11.4 31.3-22.08 44.73-8.15 10.24-15.28 21.11-14.42 35.52 1.51 0.68 2.82 1.28 3.85 1.75 1.17 0.53 2.52-0.3 2.53-1.59 0.13-13.06 6.87-23.25 14.49-32.83z"
        fill="#2E7D32"
      />
      <path
        d="m36.88 45.16c-0.46 0.6-0.9 1.15-1.36 1.73-3 3.77-6.26 7.72-9.1 11.28l42.93 19.48c0.48-0.62 0.97-1.25 1.47-1.87 2.97-3.73 6.08-7.39 9-11.13l-42.94-19.49z"
        fill="#FFECB3"
      />
      <path
        d="m79.84 64.64c-2.93 3.74-6.04 7.4-9.01 11.14-0.49 0.62-0.98 1.24-1.46 1.87l4.93 4.85c0.97-1.3 1.97-2.59 2.99-3.87 2.45-3.08 5-6.11 7.46-9.17l-4.91-4.82z"
        fill="#FFECB3"
      />
      <path
        d="m79.84 64.64c-2.93 3.74-6.04 7.4-9.01 11.14-0.49 0.62-0.98 1.24-1.46 1.87l4.93 4.85c0.97-1.3 1.97-2.59 2.99-3.87 2.45-3.08 5-6.11 7.46-9.17l-4.91-4.82z"
...
export function Chart(props) {
  return (
    ...
    >
      ...
      <rect x="4" y="4" width="120" height="120" fill="url(#chart-icon-e)" />
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#4480F7" offset=".0051509" />
        <stop stopColor="#3462BD" offset="1" />
      </linearGradient>
      <rect x="15.29" y="54.72" width="18.58" height="69.28" fill="url(#chart-icon-d)" />
      <linearGradient
        id="chart-icon-c"
        x1="50.614"
        x2="50.614"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#EC4431" offset=".0051509" />
        <stop stopColor="#E74330" offset=".3002" />
        <stop stopColor="#DA3F2D" offset=".6329" />
        <stop stopColor="#C33828" offset=".9828" />
        <stop stopColor="#C23828" offset="1" />
      </linearGradient>
      <rect x="41.32" y="80.63" width="18.58" height="43.37" fill="url(#chart-icon-c)" />
      <linearGradient
        id="chart-icon-b"
        x1="76.648"
        x2="76.648"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#FDD835" offset=".0051509" />
        <stop stopColor="#F9D534" offset=".2697" />
        <stop stopColor="#EDCB32" offset=".5326" />
        <stop stopColor="#D9BA2D" offset=".7941" />
        <stop stopColor="#C4A829" offset="1" />
      </linearGradient>
      <rect x="67.36" y="33.7" width="18.58" height="90.3" fill="url(#chart-icon-b)" />
      <linearGradient
        id="chart-icon-a"
        x1="102.68"
        x2="102.68"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#2CA94F" offset=".0079082" />
        <stop stopColor="#207A39" offset=".9969" />
      </linearGradient>
      <rect x="93.39" y="99.1" width="18.58" height="24.9" fill="url(#chart-icon-a)" />
      <g opacity=".2">
  ...
  return (
    ...
    >
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#eee" offset=".0051299" />
        <stop stopColor="#EAEAEA" offset=".2817" />
        <stop stopColor="#ddd" offset=".5766" />
        <stop stopColor="#C8C8C8" offset=".8789" />
        <stop stopColor="#BDBDBD" offset=".9998" />
      </linearGradient>
      <path
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#616161" offset=".0106" />
        <stop stopColor="#5D5D5D" offset=".2496" />
        <stop stopColor="#505050" offset=".5044" />
        <stop stopColor="#3B3B3B" offset=".7657" />
      ...
      <path d="m-88.07 180.31" stroke="#0ff" strokeMiterlimit="10" strokeWidth="1.3895" />
      <linearGradient
        id="gear-icon-e"
        x1="64.092"
        x2="64.092"
...
export function BallotBox(props) {
  return (
    <svg {...props} enableBackground="new 0 0 128 128" viewBox="0 0 128 128">
      <path
      ...
      <defs>
        <rect id="BallotBox-e" x={31.12} y={3.44} width={65.75} height={61.27} />
      </defs>
      <clipPath id="BallotBox-a">
        <use xlinkHref="#BallotBox-e" />
      </clipPath>
      <linearGradient
        id="BallotBox-d"
        x1={64.002}
      ...
      <path
        ...
        clipPath="url(#BallotBox-a)"
        fill="url(#BallotBox-d)"
      />
      <linearGradient
        id="BallotBox-c"
        x1={64.002}
      ...
      <path
        ...
        clipPath="url(#BallotBox-a)"
        fill="url(#BallotBox-c)"
      />
      <g clipPath="url(#BallotBox-a)" opacity={0.2}>
        <path
